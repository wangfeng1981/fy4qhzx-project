...
set output "demoout.hist.png"
plot 'demoout.biashist.txt' smooth freq with boxes
unset output
#scatter_image
reset
set terminal png size 800,600
set output "demoout.scatter.png"
#fitline
f(x)=a*x+b
a=1.
b=1.
fit f(x) "demoout.linear.txt" using 1:2 via a,b
set xlabel 'input'
set ylabel 'ref'
fiteq=sprintf('f(x)=%.2f*x+%.2f' , a , b) ;
set label 1 fiteq at graph 0.1 , 0.9
plot "demoout.scatter.txt" using 1:2 , f(x) with lines linecolor 7
unset output
#heatmap
reset
set terminal png size 1000,800
set output "demoout.heatmap.png"
...
r = 0.99
splot "demoout.lonlatbias.txt" using 1:2:(1):3 with pm3d,r*cos(v)*cos(u),r*cos(v)*sin(u),r*sin(v) with lines ls 0,'E:/coding/fy4qhzx-project/extras/world_110m.txt' u 1:2:(1) with lines ls 2
unset output
