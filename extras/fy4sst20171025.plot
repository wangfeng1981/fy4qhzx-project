...
####################################
splot 'E:/coding/fy4qhzx-project/extras/land_0125half.llv.txt' using 1:2:(1):3 with pm3d , "{{{INFILE}}}" using 1:2:(1):( ($3<13)*13 + ($3>=13)*$3 ) with pm3d, r*cos(v)*cos(u),r*cos(v)*sin(u),r*sin(v) with lines lt 0 lc 'grey' ,'E:/coding/fy4qhzx-project/extras/world_110m.txt' u 1:2:(1.01) with lines lt 1 lc 'grey' , 'E:/coding/fy4qhzx-project/extras/china.dat' u 1:2:(1.01) with lines lt 1 lc '#ccbbdd'  
