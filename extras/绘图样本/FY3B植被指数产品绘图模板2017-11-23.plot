...
set output 'D:/fy3b_ndvi_aotd.20170820.tif.png'
set encoding utf8
set multiplot
...
set label 1 "FY3B NDVI 2017-08-20 10-Days " at screen 0.5, screen 0.1 font 'Arial,32' center 

set label 2 "Produced:2017-11-23 20:20:31" at screen 0.1, screen 0.05 font 'Arial,12' left 


set object 1 rect from graph 0.86,0.0 to graph 1.0,0.3
set object 1 rect fc rgb 'white' fillstyle solid  0.0 noborder front
plot \
'D:/fy3b_ndvi_aotd.20170820.tif.albers.tif.xyz.txt' using 1:2:3 with image , \
