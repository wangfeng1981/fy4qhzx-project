#fy4融合积雪绘图 2017-11-16
reset
set terminal png noenhanced size 800,1000 
set output 'snow-1.png'
set multiplot
set encoding utf8
...
set label "F-Snow" at screen 0.575,screen 0.04 center font "Arial,16"



####################################
splot 'E:/coding/fy4qhzx-project/extras/global_20.llv.txt' using 1:2:(1):3 with pm3d , "snow-sm.txt" using 1:2:(1):(($3==11)*1+($3==25)*2+($3==39)*3+($3==50)*4+($3==200)*5+($3==201)*6) with pm3d, r*cos(v)*cos(u),r*cos(v)*sin(u),r*sin(v) with lines lt 0 lc 'grey' ,'E:/coding/fy4qhzx-project/extras/world_110m.txt' u 1:2:(1.01) with lines lt 1 lc 'grey' , 'E:/coding/fy4qhzx-project/extras/china2.txt' u 1:2:(1.01) with lines lt 1 lc '#ccbbdd'  

#title lables
set label 1 'FY4A-SNC And FY3C-SD Fusion Snow Cover Daily 4km' at screen 0.5, screen 0.95 center font 'Arial,16' 
set label 2 "2017-10-07"  at screen 0.5, screen 0.92 font 'Arial,16' 
