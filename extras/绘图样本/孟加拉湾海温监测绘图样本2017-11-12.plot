...
set cntrlabel  format '%8.1f' font ',7' start 5 interval 20
...
unset key
splot 'sst-xyz.txt' using 1:2:(0):3 with pm3d , ''  w l  ,''   w labels boxed 
...
set xrange[1:31]
set yrange[-5:20]
plot 'wind90E.txt' using 1:2:($3/10):($4/10) with vec
