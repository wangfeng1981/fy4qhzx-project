...
set output 't.monsoons.png'
set encoding utf8
set multiplot
#title lables
set label 1 'FY4A TPW WITH NCEP WIND FIELD 20170920 Daily'  at screen 0.5, screen 0.96 font 'Arial,16' center 
...
plot  'E:/testdata/jifeng-out/FY4A-_AGRI--_N_DISK_1047E_L2-_OLR-_MULT_NOM_20170920_OLR_combination_day.tif.xyz.txt' using 1:2:3 with image ,'E:/coding/fy4qhzx-project/extras/world_110m.txt' u 1:2 with lines  lt 1 lc '#eaea55' ,  'E:/coding/fy4qhzx-project/extras/china2.txt' u 1:2  with lines lt 1 lc '#55ff55' ,'E:/testdata/ncep-wind/2017/ncepwind.20170920.850.xyuv.txt' u 1:2:($3/5):($4/5) w vec arrowstyle 1 
