...
set output 'olr-disk-demo25-400.png'
set multiplot
set encoding utf8
...
####################################
splot 'global_20.llv.txt' using 1:2:(1):3 with pm3d , "demo.llv.txt" using 1:2:(1):( ($3<50)*50 + ($3>=50)*$3 ) with pm3d, r*cos(v)*cos(u),r*cos(v)*sin(u),r*sin(v) with lines lt 0 lc 'grey' ,'E:/coding/fy4qhzx-project/extras/world_110m.txt' u 1:2:(1.01) with lines lt 1 lc 'grey' , 'E:/coding/fy4qhzx-project/extras/china.dat' u 1:2:(1.01) with lines lt 1 lc '#ccbbdd'  



#title lables
set label 1 'FY4A OLR 20171007 Daily 4km' at screen 0.5,0.95 center font 'Arial,16' 
