...
set output 'lst-pm3d.png'
set encoding utf8
set multiplot
#title lables
set label 1 'FY4A 20170901 LST Five-Days 4km' at screen 0.5, screen 0.96 font 'Arial,16' center 
...
set x2tics offset -0.5,-0.5 border -5,1,5
set zrange[0:2] ;
set view 0,0
set origin -0.25,-0.2
...
splot 'E:/coding/fy4qhzx-project/extras/land_0125half.llv.txt' u 1:2:(0.5):3  with pm3d \
,  'fdgrid-fg.llv179.txt' using 1:2:(0.5):( ($3<260)*260 + ($3>=260)*$3 ) with pm3d \
, 'E:/coding/fy4qhzx-project/extras/world_110m.txt' u 1:2:(0.501) with lines lt 1 lc 'grey' \
, 'E:/coding/fy4qhzx-project/extras/china.dat' u 1:2:(0.501) with lines lt 1 lc '#ccbbdd' 
