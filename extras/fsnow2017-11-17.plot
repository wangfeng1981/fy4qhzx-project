...
####################################
splot  "{{{INFILE}}}" using 1:2:(1):(($3==11)*1+($3==25)*2+($3==39)*3+($3==50)*4+($3==200)*5+($3==201)*6) with pm3d, r*cos(v)*cos(u),r*cos(v)*sin(u),r*sin(v) with lines lt 0 lc 'grey' ,'E:/coding/fy4qhzx-project/extras/world_110m.txt' u 1:2:(1.01) with lines lt 1 lc 'grey' , 'E:/coding/fy4qhzx-project/extras/china2.txt' u 1:2:(1.01) with lines lt 1 lc '#ccbbdd'  
